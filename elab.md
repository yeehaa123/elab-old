...
Wij stellen voor ditzelfde principe ook in het elab te implementeren. Stafleden en studenten leren gebruik maken van een klein aantal standaard tools waarmee tachtig procent van de problemen kunnen worden aangepakt. Slecht voor de resterende twintig procent moet dan nog naar aangepaste oplossingen gezocht worden. Nu is dit vaak nog omgekeerd. 

Een ander voordeel van 'convention over configuration' is dat datasets en tools makkelijker uitgewisseld en hergebruikt kunnen worden. Ook kan er op deze manier makkelijker worden samengewerkt en onderwijs ontwikkeld worden. Dit moet leiden tot een efficienter en effectiever gebruikt van ondersteuning, dat dan nog slecht wordt ingezet voor complexe en specifieke problemen. 
